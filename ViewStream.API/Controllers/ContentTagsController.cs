...
[ApiController]
[Route("api/v1/admin/contenttags")]
[EnableRateLimiting("AdminRateLimit")]
[Authorize(Roles = "SuperAdmin,ContentManager,Moderator")]
[Produces("application/json")]
public class AdminContentTagsController : ControllerBase
{
    private readonly IMediator _mediator;

    public AdminContentTagsController(IMediator mediator) => _mediator = mediator;

    /// <summary>
    /// Retrieves a paginated list of content tags for the admin dashboard.
    /// </summary>
    ...
    public async Task<ActionResult<PagedResult<AdminContentTagListItemDto>>> GetAdminPaged(
        ...
        CancellationToken cancellationToken = default)
    {
        var query = new GetAdminContentTagsPagedQuery(pageNumber, pageSize, searchTerm, sortBy, sortDescending, includeDeleted);
