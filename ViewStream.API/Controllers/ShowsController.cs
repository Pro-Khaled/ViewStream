...
public class ShowsController : ControllerBase
{
    ...
    public async Task<ActionResult<ShowDto>> GetShow(long id, CancellationToken cancellationToken)
    {
        ...
        /// <summary>
        /// Retrieves a paginated list of shows with optional filters for the admin dashboard.
        /// </summary>
        ...
        /// <param name="genreId">Optional filter by genreid.</param>
        /// <param name="releaseYear">Optional filter by releaseyear.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A paginated list of shows.</returns>
        ...
        [FromQuery] int? releaseYear = null,
            CancellationToken cancellationToken = default)
        {
            var query = new GetAdminShowsPagedQuery(pageNumber, pageSize, searchTerm, sortBy, sortDescending, includeDeleted, genreId, releaseYear);
